...
平时在vim中编写pytest用例和base class代码时，为了规范话代码风格与一些基本错误的静态代码检查，会借助pylint做代码检查，避免出现一些低级错误。


# .pylintrc内容示例参考


如下是我自己常用的pylintrc file，pylint的详细信息，请参考官网： ``` https://docs.pylint.org/#command-line-options```
